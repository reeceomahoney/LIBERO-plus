...
from libero_plus.libero_plus.envs.bddl_utils import get_regions, get_scenes
from libero_plus.libero_plus.utils.bddl_generation_utils import get_xy_region_kwargs_list_from_regions_info, get_result
from libero_plus.libero_plus.utils.task_generation_utils import get_suite_generator_func
from libero_plus.libero_plus.utils.mu_utils import InitialSceneTemplates
...
def _robosuite_parse_problem(bddl_str: str):
    """Modified from: libero_plus.libero_plus.envs.bddl_utils.robosuite_parse_problem"""
...
def _problem_name_to_workspace_name(problem_name: str) -> str:
    ...
    if "LIBERO_Tabletop_Manipulation".lower() == problem_name:
        ...
        return "floor"  # Note that this does not present in `libero_plus.libero_plus.utils.task_generation_utils.get_suite_generator_func`, I found in file `libero_plus.libero_plus.envs.problems.libero_floor_manipulation.Libero_Floor_Manipulation`
    else:
